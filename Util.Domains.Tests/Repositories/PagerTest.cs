...
namespace Util.Domains.Tests.Repositories {
    ...
    public class PagerTest {
        ...
        public void Test_Default() {
            ...
            Assert.AreEqual( 0, _pager.GetPageCount() );
            Assert.AreEqual( 0, _pager.GetSkipCount() );
            Assert.AreEqual( "", _pager.Order );
            Assert.AreEqual( 1, _pager.GetStartNumber() );
            Assert.AreEqual( 20, _pager.GetEndNumber() );
        }
        ...
        public void TestPageCount_TotalCountIs100() {
            ...
            Assert.AreEqual( 5, _pager.GetPageCount() );
        }
        ...
        public void TestPageCount_TotalCountIs1() {
            _pager.TotalCount = 1;
            Assert.AreEqual( 1, _pager.GetPageCount() );
        }
        ...
        public void TestPageCount_PageSizeIs10_TotalCountIs100() {
            _pager.PageSize = 10;
            _pager.TotalCount = 100;
            Assert.AreEqual( 10, _pager.GetPageCount() );
        }
        ...
        public void TestSkipCount() {
            ...
            _pager.Page = 2;
            Assert.AreEqual( 20, _pager.GetSkipCount() );

            _pager.Page = 3;
            Assert.AreEqual( 40, _pager.GetSkipCount() );

            _pager.Page = 4;
            Assert.AreEqual( 60, _pager.GetSkipCount() );

            _pager.Page = 5;
            Assert.AreEqual( 80, _pager.GetSkipCount() );
        ...
        public void Test_StartNumber_EndNumber() {
            _pager.Page = 2;
            _pager.PageSize = 10;
            Assert.AreEqual( 11, _pager.GetStartNumber() );
            Assert.AreEqual( 20, _pager.GetEndNumber() );
        }
