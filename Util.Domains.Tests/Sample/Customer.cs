...
namespace Util.Domains.Tests.Sample {
    ...
    public class Customer : AggregateRoot<Customer, int> {
        ...
        public static Customer CreateRandomCustomer() {
            ...
            customer.Name = randomBuilder.GenerateChinese( 5 );
            customer.EnglishName = randomBuilder.GenerateLetters( 5 );
            customer.Age = 10;
            customer.Tel = 1;
            customer.Db = 1.1;
            customer.NullableDb = 1.1;
        ...
        protected override void AddChanges( Customer newEntity ) {
            AddChange( "Name", "客户名称", Name, newEntity.Name,true );
            AddChange( "Dec", "decimal测试", Dec, newEntity.Dec );
            AddChange( Employee, newEntity.Employee );
            AddChange( Employees, newEntity.Employees );
        }
    }
}
