...
namespace EmitMapper.MappingConfiguration
{
    public abstract class MapConfigBaseImpl : IMappingConfigurator
    {
        ...
        public IEnumerable<IMappingOperation> FilterOperations(
            Type from,
            Type to,
        ...
        public static string ToStrEnum<T>(IEnumerable<T> t)
        {
            return t == null ? "" : t.ToCSV("|");
        }

        public static string ToStr<T>(T t) where T : class
        {
            return t == null ? "" : t.ToString();
        }

		public virtual void RegisterDefaultCollectionConverters()
		{
