...
namespace EmitMapper.Mappers
{
    ...
    public class MapperForCollectionImpl : CustomMapperImpl
    {
        ...
        public static Type GetSubMapperTypeTo(Type to)
        {
            return ExtractElementType(to);
        }

        public static Type GetSubMapperTypeFrom(Type from) 
        {
        ...
        public MapperForCollectionImpl() :base(null, null, null, null, null)
        {
        }
        ...
        public List<T> CopyToList<T>(IEnumerable from)
        {
            List<T> result;
            if (from is ICollection)
            {
        ...
        public virtual object CopyToListInvoke(IEnumerable from)
        {
            return null;
        }

        public List<T> CopyToListScalar<T>(object from)
        {
            List<T> result = new List<T>(1);
            result.Add((T)subMapper.mapper.Map(from));
            return result;
        }
        public virtual object CopyToListScalarInvoke(object from)
        {
            return null;
        }
