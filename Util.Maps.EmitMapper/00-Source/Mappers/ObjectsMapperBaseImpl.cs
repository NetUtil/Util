...
namespace EmitMapper.Mappers
{
    ...
    public abstract class ObjectsMapperBaseImpl
    {
        ...
        /// Mapper manager
        /// </summary>
        public ObjectMapperManager mapperMannager;
		...
		public IMappingConfigurator _mappingConfigurator;
		public IRootMappingOperation _rootOperation;

		public object[] StroredObjects;

        public DelegateInvokerFunc_0 _targetConstructor;
        public DelegateInvokerFunc_0 _nullSubstitutor;
        public DelegateInvokerFunc_2 _converter;
        public DelegateInvokerFunc_2 _valuesPostProcessor;
